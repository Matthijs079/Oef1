...
class RegelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regels = $em->getRepository('MainBundle:Regel')->findAll();

        return $this->render('@Main/regel/index.html.twig', array(
            'regels' => $regels,
        ));
    }
    ...
    {
        $regel = new Regel();
        $form = $this->createForm('MainBundle\Form\RegelType', $regel);
        ...
        return $this->render('@Main/regel/new.html.twig', array(
            'regel' => $regel,
    ...
    public function showAction(Regel $regel)
    {
        ...
        return $this->render('@Main/regel/show.html.twig', array(
            'regel' => $regel,
    ...
    {
        $deleteForm = $this->createDeleteForm($regel);
        $editForm = $this->createForm('MainBundle\Form\RegelType', $regel);
        ...
        return $this->render('@Main/regel/edit.html.twig', array(
            'regel' => $regel,
