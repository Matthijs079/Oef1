...
class FactuurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $factuurs = $em->getRepository('MainBundle:Factuur')->findAll();

        return $this->render('@Main/factuur/index.html.twig', array(
            'factuurs' => $factuurs,
        ));
    }
    ...
    {
        $factuur = new Factuur();
        $form = $this->createForm('MainBundle\Form\FactuurType', $factuur);
        ...
        return $this->render('@Main/factuur/new.html.twig', array(
            'factuur' => $factuur,
    ...
    public function showAction(Factuur $factuur)
    {
        ...
        return $this->render('@Main/factuur/show.html.twig', array(
            'factuur' => $factuur,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $regels = $em->getRepository(Regel::class)->findby(['factuur' => $factuur->getId()]);
        ...
        $deleteForm = $this->createDeleteForm($factuur);
        $editForm = $this->createForm('MainBundle\Form\FactuurType', $factuur);
        ...
        return $this->render('@Main/factuur/edit.html.twig', array(
            'factuur' => $factuur,
